...
const day = "Days of Mischief"
const location = "The Cackling Crab"
const tpd = 5
const start = {"day":21,"month":10,"year":2024,"hour":0}
const end = {"day":10,"month":11,"year":2024,"hour":23,"minute":59}
